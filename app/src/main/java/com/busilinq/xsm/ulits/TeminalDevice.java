...
public class TeminalDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return MApplication.context().getResources().getDisplayMetrics();
    }
    ...
    public static boolean hasInternet() {
        ConnectivityManager cm = (ConnectivityManager) MApplication.context()
    ...
    public static boolean isPortrait() {
        return MApplication.context().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = MApplication.context().getResources().getConfiguration().screenLayout;
    ...
    public static int getVersionCode() {
        return getVersionCode(MApplication.context().getPackageName());
    }
    ...
    public static String getVersionName() {
        try {
            return MApplication
                    .context()
                    .getPackageManager()
                    .getPackageInfo(MApplication.context().getPackageName(), 0)
                    .versionName;
        } catch (PackageManager.NameNotFoundException ex) {
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) MApplication.context()
    ...
    public static String getDeviceId() {
        TelephonyManager tm = (TelephonyManager) MApplication.context().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getUUid() {
        ACache cache = ACache.get(MApplication.context());
        String uuid = cache.getAsString("uuid");
        if (null == uuid) {
    ...
    public static String getPhoneInfo() {
        ...
        String maded = Build.MANUFACTURER.toLowerCase();
        if (null == model) {
            model = "undefined";
        }
        if (null == maded) {
        ...
        String phoneinfo = os + "," + maded + "," + model;
        return phoneinfo;
    }


    public static String getUmsAppId(int falg) {
        try {
            return MApplication.context().getPackageManager()
                    .getApplicationInfo(MApplication.context().getPackageName(), falg).metaData.getString("com.ums.upos.APP_ID");
        } catch (PackageManager.NameNotFoundException ex) {
            return "undefined version name";
        }
    }
