 ...
 * Create Person：yu
 * Create Time：2018-2-9 09:32:36
 * Update Person：
 * Update Time：
 * Update Remark：
 */
public class CartOldAdapter extends AbstractRecyclerViewAdapter<MainCartEntity> {

    public interface MyInterface{
        void getCarInfo();
    }
    private MyInterface myInterface;
    public CartOldAdapter(Context context, MyInterface myInterface) {
        super(context);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CartOldAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        final CartOldAdapter.ViewHolder vHolder = (CartOldAdapter.ViewHolder) holder;
